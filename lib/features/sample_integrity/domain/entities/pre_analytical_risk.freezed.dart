...
mixin _$PreAnalyticalRiskAssessment {
 ...
 RiskLevel get riskLevel; List<RiskFactor> get factors; DateTime get assessedAt; String? get recommendation; bool? get requiresRecollection; double? get sampleViabilityProbability;
/// Create a copy of PreAnalyticalRiskAssessment
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$PreAnalyticalRiskAssessmentCopyWith<PreAnalyticalRiskAssessment> get copyWith => _$PreAnalyticalRiskAssessmentCopyWithImpl<PreAnalyticalRiskAssessment>(this as PreAnalyticalRiskAssessment, _$identity);
...
abstract mixin class $PreAnalyticalRiskAssessmentCopyWith<$Res>  {
  factory $PreAnalyticalRiskAssessmentCopyWith(PreAnalyticalRiskAssessment value, $Res Function(PreAnalyticalRiskAssessment) _then) = _$PreAnalyticalRiskAssessmentCopyWithImpl;
@useResult
$Res call({
 double riskScore, RiskLevel riskLevel, List<RiskFactor> factors, DateTime assessedAt, String? recommendation, bool? requiresRecollection, double? sampleViabilityProbability
});
...
as RiskLevel,factors: null == factors ? _self.factors : factors // ignore: cast_nullable_to_non_nullable
as List<RiskFactor>,assessedAt: null == assessedAt ? _self.assessedAt : assessedAt // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _PreAnalyticalRiskAssessment value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _PreAnalyticalRiskAssessment value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _PreAnalyticalRiskAssessment value)?  $default,){
final _that = this;
switch (_that) {
case _PreAnalyticalRiskAssessment() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( double riskScore,  RiskLevel riskLevel,  List<RiskFactor> factors,  DateTime assessedAt,  String? recommendation,  bool? requiresRecollection,  double? sampleViabilityProbability)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PreAnalyticalRiskAssessment() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( double riskScore,  RiskLevel riskLevel,  List<RiskFactor> factors,  DateTime assessedAt,  String? recommendation,  bool? requiresRecollection,  double? sampleViabilityProbability)  $default,) {final _that = this;
switch (_that) {
case _PreAnalyticalRiskAssessment():
return $default(_that.riskScore,_that.riskLevel,_that.factors,_that.assessedAt,_that.recommendation,_that.requiresRecollection,_that.sampleViabilityProbability);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( double riskScore,  RiskLevel riskLevel,  List<RiskFactor> factors,  DateTime assessedAt,  String? recommendation,  bool? requiresRecollection,  double? sampleViabilityProbability)?  $default,) {final _that = this;
switch (_that) {
case _PreAnalyticalRiskAssessment() when $default != null:
return $default(_that.riskScore,_that.riskLevel,_that.factors,_that.assessedAt,_that.recommendation,_that.requiresRecollection,_that.sampleViabilityProbability);case _:
  return null;
...
class _PreAnalyticalRiskAssessment implements PreAnalyticalRiskAssessment {
  const _PreAnalyticalRiskAssessment({required this.riskScore, required this.riskLevel, required final  List<RiskFactor> factors, required this.assessedAt, this.recommendation, this.requiresRecollection, this.sampleViabilityProbability}): _factors = factors;
  factory _PreAnalyticalRiskAssessment.fromJson(Map<String, dynamic> json) => _$PreAnalyticalRiskAssessmentFromJson(json);
...
@pragma('vm:prefer-inline')
_$PreAnalyticalRiskAssessmentCopyWith<_PreAnalyticalRiskAssessment> get copyWith => __$PreAnalyticalRiskAssessmentCopyWithImpl<_PreAnalyticalRiskAssessment>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$PreAnalyticalRiskAssessmentToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _PreAnalyticalRiskAssessment&&(identical(other.riskScore, riskScore) || other.riskScore == riskScore)&&(identical(other.riskLevel, riskLevel) || other.riskLevel == riskLevel)&&const DeepCollectionEquality().equals(other._factors, _factors)&&(identical(other.assessedAt, assessedAt) || other.assessedAt == assessedAt)&&(identical(other.recommendation, recommendation) || other.recommendation == recommendation)&&(identical(other.requiresRecollection, requiresRecollection) || other.requiresRecollection == requiresRecollection)&&(identical(other.sampleViabilityProbability, sampleViabilityProbability) || other.sampleViabilityProbability == sampleViabilityProbability));
}
...
/// @nodoc
abstract mixin class _$PreAnalyticalRiskAssessmentCopyWith<$Res> implements $PreAnalyticalRiskAssessmentCopyWith<$Res> {
  factory _$PreAnalyticalRiskAssessmentCopyWith(_PreAnalyticalRiskAssessment value, $Res Function(_PreAnalyticalRiskAssessment) _then) = __$PreAnalyticalRiskAssessmentCopyWithImpl;
@override @useResult
$Res call({
 double riskScore, RiskLevel riskLevel, List<RiskFactor> factors, DateTime assessedAt, String? recommendation, bool? requiresRecollection, double? sampleViabilityProbability
});
...
riskScore: null == riskScore ? _self.riskScore : riskScore // ignore: cast_nullable_to_non_nullable
as double,riskLevel: null == riskLevel ? _self.riskLevel : riskLevel // ignore: cast_nullable_to_non_nullable
as RiskLevel,factors: null == factors ? _self._factors : factors // ignore: cast_nullable_to_non_nullable
as List<RiskFactor>,assessedAt: null == assessedAt ? _self.assessedAt : assessedAt // ignore: cast_nullable_to_non_nullable
as DateTime,recommendation: freezed == recommendation ? _self.recommendation : recommendation // ignore: cast_nullable_to_non_nullable
as String?,requiresRecollection: freezed == requiresRecollection ? _self.requiresRecollection : requiresRecollection // ignore: cast_nullable_to_non_nullable
as bool?,sampleViabilityProbability: freezed == sampleViabilityProbability ? _self.sampleViabilityProbability : sampleViabilityProbability // ignore: cast_nullable_to_non_nullable
...
mixin _$RiskFactor {
 ...
 RiskFactorType get type; double get impact;// 0-100
 String get description; bool? get detected; Map<String, dynamic>? get metadata;
...
@useResult
$Res call({
 RiskFactorType type, double impact, String description, bool? detected, Map<String, dynamic>? metadata
});
...
as RiskFactorType,impact: null == impact ? _self.impact : impact // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( RiskFactorType type,  double impact,  String description,  bool? detected,  Map<String, dynamic>? metadata)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RiskFactor() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( RiskFactorType type,  double impact,  String description,  bool? detected,  Map<String, dynamic>? metadata)  $default,) {final _that = this;
switch (_that) {
case _RiskFactor():
return $default(_that.type,_that.impact,_that.description,_that.detected,_that.metadata);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( RiskFactorType type,  double impact,  String description,  bool? detected,  Map<String, dynamic>? metadata)?  $default,) {final _that = this;
switch (_that) {
case _RiskFactor() when $default != null:
return $default(_that.type,_that.impact,_that.description,_that.detected,_that.metadata);case _:
  return null;
...
class _RiskFactor implements RiskFactor {
  const _RiskFactor({required this.type, required this.impact, required this.description, this.detected, final  Map<String, dynamic>? metadata}): _metadata = metadata;
  factory _RiskFactor.fromJson(Map<String, dynamic> json) => _$RiskFactorFromJson(json);

@override final  RiskFactorType type;
