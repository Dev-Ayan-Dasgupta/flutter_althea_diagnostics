...
class CalculateIntegrityScore implements UseCase<SampleIntegrityScore, String> {
  final SampleIntegrityRepository repository;

  CalculateIntegrityScore(this.repository);

  @override
  Future<Either<Failure, SampleIntegrityScore>> call(String sampleId) async {
    return await repository.calculateIntegrityScore(sampleId);
  }
}
