...
mixin _$AssessPreAnalyticalRiskParams {
  ...
  $AssessPreAnalyticalRiskParamsCopyWith<AssessPreAnalyticalRiskParams>
      get copyWith => _$AssessPreAnalyticalRiskParamsCopyWithImpl<
              AssessPreAnalyticalRiskParams>(
          this as AssessPreAnalyticalRiskParams, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is AssessPreAnalyticalRiskParams &&
            (identical(other.sampleId, sampleId) ||
                other.sampleId == sampleId) &&
            const DeepCollectionEquality()
                .equals(other.collectionData, collectionData));
  }

  @override
  int get hashCode => Object.hash(runtimeType, sampleId,
      const DeepCollectionEquality().hash(collectionData));
...
abstract mixin class $AssessPreAnalyticalRiskParamsCopyWith<$Res> {
  factory $AssessPreAnalyticalRiskParamsCopyWith(
          AssessPreAnalyticalRiskParams value,
          $Res Function(AssessPreAnalyticalRiskParams) _then) =
      _$AssessPreAnalyticalRiskParamsCopyWithImpl;
  @useResult
  $Res call({String sampleId, Map<String, dynamic> collectionData});
}
    ...
    return _then(_self.copyWith(
      sampleId: null == sampleId
          ...
          : sampleId // ignore: cast_nullable_to_non_nullable
              as String,
      collectionData: null == collectionData
          ? _self.collectionData
...
extension AssessPreAnalyticalRiskParamsPatterns
    on AssessPreAnalyticalRiskParams {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_AssessPreAnalyticalRiskParams value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String sampleId, Map<String, dynamic> collectionData)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _AssessPreAnalyticalRiskParams() when $default != null:
        return $default(_that.sampleId, _that.collectionData);
      case _:
        return orElse();
    }
  }
...
class _AssessPreAnalyticalRiskParams implements AssessPreAnalyticalRiskParams {
  const _AssessPreAnalyticalRiskParams(
      {required this.sampleId,
      required final Map<String, dynamic> collectionData})
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AssessPreAnalyticalRiskParamsCopyWith<_AssessPreAnalyticalRiskParams>
      get copyWith => __$AssessPreAnalyticalRiskParamsCopyWithImpl<
          _AssessPreAnalyticalRiskParams>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _AssessPreAnalyticalRiskParams &&
            (identical(other.sampleId, sampleId) ||
                other.sampleId == sampleId) &&
            const DeepCollectionEquality()
...
/// @nodoc
abstract mixin class _$AssessPreAnalyticalRiskParamsCopyWith<$Res>
    implements $AssessPreAnalyticalRiskParamsCopyWith<$Res> {
  factory _$AssessPreAnalyticalRiskParamsCopyWith(
          _AssessPreAnalyticalRiskParams value,
          $Res Function(_AssessPreAnalyticalRiskParams) _then) =
      __$AssessPreAnalyticalRiskParamsCopyWithImpl;
  @override
  @useResult
  $Res call({String sampleId, Map<String, dynamic> collectionData});
}
