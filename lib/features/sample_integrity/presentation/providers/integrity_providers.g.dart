...
part of 'integrity_providers.dart';
...
@ProviderFor(sampleIntegrityRemoteDataSource)
...
final class SampleIntegrityRemoteDataSourceProvider
  ...
  SampleIntegrityRemoteDataSource create(Ref ref) {
    return sampleIntegrityRemoteDataSource(ref);
  }
...
String _$sampleIntegrityRemoteDataSourceHash() =>
    r'3485c7ca64513489b10454b500e88d04ad0c438c';
...
final class SampleIntegrityRepositoryProvider
  ...
  SampleIntegrityRepository create(Ref ref) {
    return sampleIntegrityRepository(ref);
  }

  /// {@macro riverpod.override_with_value}
  Override overrideWithValue(SampleIntegrityRepository value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $SyncValueProvider<SampleIntegrityRepository>(value),
    );
  }
}

String _$sampleIntegrityRepositoryHash() =>
    r'b5ebb8b8b0b3960af9c6bd6de8dc7f952f752ae7';

@ProviderFor(calculateIntegrityScoreUseCase)
...
final class CalculateIntegrityScoreUseCaseProvider
  ...
  CalculateIntegrityScore create(Ref ref) {
    return calculateIntegrityScoreUseCase(ref);
  }

  /// {@macro riverpod.override_with_value}
  Override overrideWithValue(CalculateIntegrityScore value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $SyncValueProvider<CalculateIntegrityScore>(value),
    );
  }
}

String _$calculateIntegrityScoreUseCaseHash() =>
    r'ff7c8decbe1680cc6bee6c10b0c7390720a22145';
...
final class GetIntegrityScoreUseCaseProvider
  ...
  GetIntegrityScore create(Ref ref) {
    return getIntegrityScoreUseCase(ref);
  }

  /// {@macro riverpod.override_with_value}
  Override overrideWithValue(GetIntegrityScore value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $SyncValueProvider<GetIntegrityScore>(value),
    );
  }
}

String _$getIntegrityScoreUseCaseHash() =>
    r'58240e7a4d740768bba8a6a851d0297dbe967442';

@ProviderFor(assessPreAnalyticalRiskUseCase)
...
final class AssessPreAnalyticalRiskUseCaseProvider
  ...
  AssessPreAnalyticalRisk create(Ref ref) {
    return assessPreAnalyticalRiskUseCase(ref);
  }

  /// {@macro riverpod.override_with_value}
  Override overrideWithValue(AssessPreAnalyticalRisk value) {
    return $ProviderOverride(
      origin: this,
      providerOverride: $SyncValueProvider<AssessPreAnalyticalRisk>(value),
    );
  }
}

String _$assessPreAnalyticalRiskUseCaseHash() =>
    r'f76e395515b7de39ea7516726f3147c09ef2853f';
...
final class IntegrityScoreNotifierProvider
  ...
  @override
  String toString() {
    return r'integrityScoreProvider'
        ''
        '($argument)';
  }
  ...
  @$internal
  @override
  IntegrityScoreNotifier create() => IntegrityScoreNotifier();

  @override
  bool operator ==(Object other) {
    return other is IntegrityScoreNotifierProvider &&
...
String _$integrityScoreNotifierHash() =>
    r'e2aad2b3bbcc5c8bb73c69114d264c4fa89ca5e9';
...
final class IntegrityScoreNotifierFamily extends $Family
  ...
  @override
  String toString() => r'integrityScoreProvider';
}

abstract class _$IntegrityScoreNotifier
    extends $AsyncNotifier<SampleIntegrityScore> {
...
@ProviderFor(integrityLevelColor)
...
final class IntegrityLevelColorProvider
  ...
  @override
  String toString() {
    return r'integrityLevelColorProvider'
        ''
        '($argument)';
  }
  ...
  @override
  bool operator ==(Object other) {
    return other is IntegrityLevelColorProvider && other.argument == argument;
  }
...
String _$integrityLevelColorHash() =>
    r'55bd46fb9dbbf21ebc953053e79a2c98dc21a330';
...
final class IntegrityLevelColorFamily extends $Family
  ...
  @override
  String toString() => r'integrityLevelColorProvider';
}
