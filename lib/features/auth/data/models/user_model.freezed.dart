...
mixin _$UserModel {
 ...
 String get id; String get name; String get email; String? get phoneNumber; String? get avatarUrl; String get role; String get labId; String? get labName; List<String> get permissions; String get createdAt; String? get lastLoginAt;// Phlebotomist-specific fields
 String? get phlebotomistStatus; double? get currentBalance; int? get totalCollections; double? get averageRating; List<String>? get certifications; String? get vehicleNumber; bool? get isAvailableForCollection;// Lab Admin-specific fields
...
@useResult
$Res call({
 String id, String name, String email, String? phoneNumber, String? avatarUrl, String role, String labId, String? labName, List<String> permissions, String createdAt, String? lastLoginAt, String? phlebotomistStatus, double? currentBalance, int? totalCollections, double? averageRating, List<String>? certifications, String? vehicleNumber, bool? isAvailableForCollection, List<String>? managedLabIds, int? staffCount, String? licenseNumber
});
...
as String?,phlebotomistStatus: freezed == phlebotomistStatus ? _self.phlebotomistStatus : phlebotomistStatus // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String email,  String? phoneNumber,  String? avatarUrl,  String role,  String labId,  String? labName,  List<String> permissions,  String createdAt,  String? lastLoginAt,  String? phlebotomistStatus,  double? currentBalance,  int? totalCollections,  double? averageRating,  List<String>? certifications,  String? vehicleNumber,  bool? isAvailableForCollection,  List<String>? managedLabIds,  int? staffCount,  String? licenseNumber)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UserModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String email,  String? phoneNumber,  String? avatarUrl,  String role,  String labId,  String? labName,  List<String> permissions,  String createdAt,  String? lastLoginAt,  String? phlebotomistStatus,  double? currentBalance,  int? totalCollections,  double? averageRating,  List<String>? certifications,  String? vehicleNumber,  bool? isAvailableForCollection,  List<String>? managedLabIds,  int? staffCount,  String? licenseNumber)  $default,) {final _that = this;
switch (_that) {
case _UserModel():
return $default(_that.id,_that.name,_that.email,_that.phoneNumber,_that.avatarUrl,_that.role,_that.labId,_that.labName,_that.permissions,_that.createdAt,_that.lastLoginAt,_that.phlebotomistStatus,_that.currentBalance,_that.totalCollections,_that.averageRating,_that.certifications,_that.vehicleNumber,_that.isAvailableForCollection,_that.managedLabIds,_that.staffCount,_that.licenseNumber);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  String email,  String? phoneNumber,  String? avatarUrl,  String role,  String labId,  String? labName,  List<String> permissions,  String createdAt,  String? lastLoginAt,  String? phlebotomistStatus,  double? currentBalance,  int? totalCollections,  double? averageRating,  List<String>? certifications,  String? vehicleNumber,  bool? isAvailableForCollection,  List<String>? managedLabIds,  int? staffCount,  String? licenseNumber)?  $default,) {final _that = this;
switch (_that) {
case _UserModel() when $default != null:
return $default(_that.id,_that.name,_that.email,_that.phoneNumber,_that.avatarUrl,_that.role,_that.labId,_that.labName,_that.permissions,_that.createdAt,_that.lastLoginAt,_that.phlebotomistStatus,_that.currentBalance,_that.totalCollections,_that.averageRating,_that.certifications,_that.vehicleNumber,_that.isAvailableForCollection,_that.managedLabIds,_that.staffCount,_that.licenseNumber);case _:
  return null;
...
class _UserModel implements UserModel {
  const _UserModel({required this.id, required this.name, required this.email, this.phoneNumber, this.avatarUrl, required this.role, required this.labId, this.labName, required final  List<String> permissions, required this.createdAt, this.lastLoginAt, this.phlebotomistStatus, this.currentBalance, this.totalCollections, this.averageRating, final  List<String>? certifications, this.vehicleNumber, this.isAvailableForCollection, final  List<String>? managedLabIds, this.staffCount, this.licenseNumber}): _permissions = permissions,_certifications = certifications,_managedLabIds = managedLabIds;
...
@override final  String? phlebotomistStatus;
...
mixin _$AuthTokenModel {
 ...
 String get accessToken; String get refreshToken; String get tokenType; int get expiresIn; String get issuedAt;
...
@useResult
$Res call({
 String accessToken, String refreshToken, String tokenType, int expiresIn, String issuedAt
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String accessToken,  String refreshToken,  String tokenType,  int expiresIn,  String issuedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AuthTokenModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String accessToken,  String refreshToken,  String tokenType,  int expiresIn,  String issuedAt)  $default,) {final _that = this;
switch (_that) {
case _AuthTokenModel():
return $default(_that.accessToken,_that.refreshToken,_that.tokenType,_that.expiresIn,_that.issuedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String accessToken,  String refreshToken,  String tokenType,  int expiresIn,  String issuedAt)?  $default,) {final _that = this;
switch (_that) {
case _AuthTokenModel() when $default != null:
return $default(_that.accessToken,_that.refreshToken,_that.tokenType,_that.expiresIn,_that.issuedAt);case _:
  return null;
...
class _AuthTokenModel implements AuthTokenModel {
  const _AuthTokenModel({required this.accessToken, required this.refreshToken, required this.tokenType, required this.expiresIn, required this.issuedAt});
