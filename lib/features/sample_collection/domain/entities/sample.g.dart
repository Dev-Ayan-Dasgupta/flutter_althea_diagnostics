...
_Sample _$SampleFromJson(Map<String, dynamic> json) => _Sample(
  ...
  coldChainData: json['coldChainData'] == null
      ? null
      : ColdChainData.fromJson(json['coldChainData'] as Map<String, dynamic>),
...
) => SampleStatusRequested($type: json['runtimeType'] as String?);
...
_SampleCondition _$SampleConditionFromJson(Map<String, dynamic> json) =>
    _SampleCondition(
      ...
      containerIntegrity: $enumDecode(
        _$ContainerIntegrityEnumMap,
        json['containerIntegrity'],
      ),
      notes: json['notes'] as String?,
    );
