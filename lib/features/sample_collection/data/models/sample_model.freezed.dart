...
mixin _$SampleModel {
 ...
 String get id; String get vialId; String get patientAbhaId; String get patientName; String get orderId; List<String> get testIds; Map<String, dynamic> get status; String get collectionTime; SampleIntegrityScoreModel get integrityScore; List<SampleEventModel> get chainOfCustody; String? get phlebotomistId; String? get phlebotomistName; String? get labId; String? get labName; String? get reachedLabTime; String? get processingStartTime; String? get processingEndTime; ColdChainDataModel? get coldChainData; BiometricVerificationModel? get biometricVerification; PreAnalyticalRiskModel? get preAnalyticalRisk; SampleConditionModel? get condition; String? get notes; List<String> get imageUrls; String get createdAt; String? get updatedAt;
...
@useResult
$Res call({
 String id, String vialId, String patientAbhaId, String patientName, String orderId, List<String> testIds, Map<String, dynamic> status, String collectionTime, SampleIntegrityScoreModel integrityScore, List<SampleEventModel> chainOfCustody, String? phlebotomistId, String? phlebotomistName, String? labId, String? labName, String? reachedLabTime, String? processingStartTime, String? processingEndTime, ColdChainDataModel? coldChainData, BiometricVerificationModel? biometricVerification, PreAnalyticalRiskModel? preAnalyticalRisk, SampleConditionModel? condition, String? notes, List<String> imageUrls, String createdAt, String? updatedAt
});


$SampleIntegrityScoreModelCopyWith<$Res> get integrityScore;$ColdChainDataModelCopyWith<$Res>? get coldChainData;$BiometricVerificationModelCopyWith<$Res>? get biometricVerification;$PreAnalyticalRiskModelCopyWith<$Res>? get preAnalyticalRisk;$SampleConditionModelCopyWith<$Res>? get condition;
...
as Map<String, dynamic>,collectionTime: null == collectionTime ? _self.collectionTime : collectionTime // ignore: cast_nullable_to_non_nullable
as String,integrityScore: null == integrityScore ? _self.integrityScore : integrityScore // ignore: cast_nullable_to_non_nullable
as SampleIntegrityScoreModel,chainOfCustody: null == chainOfCustody ? _self.chainOfCustody : chainOfCustody // ignore: cast_nullable_to_non_nullable
as List<SampleEventModel>,phlebotomistId: freezed == phlebotomistId ? _self.phlebotomistId : phlebotomistId // ignore: cast_nullable_to_non_nullable
...
as String?,processingStartTime: freezed == processingStartTime ? _self.processingStartTime : processingStartTime // ignore: cast_nullable_to_non_nullable
as String?,processingEndTime: freezed == processingEndTime ? _self.processingEndTime : processingEndTime // ignore: cast_nullable_to_non_nullable
as String?,coldChainData: freezed == coldChainData ? _self.coldChainData : coldChainData // ignore: cast_nullable_to_non_nullable
as ColdChainDataModel?,biometricVerification: freezed == biometricVerification ? _self.biometricVerification : biometricVerification // ignore: cast_nullable_to_non_nullable
as BiometricVerificationModel?,preAnalyticalRisk: freezed == preAnalyticalRisk ? _self.preAnalyticalRisk : preAnalyticalRisk // ignore: cast_nullable_to_non_nullable
as PreAnalyticalRiskModel?,condition: freezed == condition ? _self.condition : condition // ignore: cast_nullable_to_non_nullable
as SampleConditionModel?,notes: freezed == notes ? _self.notes : notes // ignore: cast_nullable_to_non_nullable
...
$SampleIntegrityScoreModelCopyWith<$Res> get integrityScore {
  ...
  return $SampleIntegrityScoreModelCopyWith<$Res>(_self.integrityScore, (value) {
...
$BiometricVerificationModelCopyWith<$Res>? get biometricVerification {
  ...
  return $BiometricVerificationModelCopyWith<$Res>(_self.biometricVerification!, (value) {
...
$PreAnalyticalRiskModelCopyWith<$Res>? get preAnalyticalRisk {
  ...
  return $PreAnalyticalRiskModelCopyWith<$Res>(_self.preAnalyticalRisk!, (value) {
...
@override final  String collectionTime;
@override final  SampleIntegrityScoreModel integrityScore;
 final  List<SampleEventModel> _chainOfCustody;
@override List<SampleEventModel> get chainOfCustody {
...
@override final  String? reachedLabTime;
@override final  String? processingStartTime;
@override final  String? processingEndTime;
@override final  ColdChainDataModel? coldChainData;
@override final  BiometricVerificationModel? biometricVerification;
@override final  PreAnalyticalRiskModel? preAnalyticalRisk;
@override final  SampleConditionModel? condition;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SampleModel&&(identical(other.id, id) || other.id == id)&&(identical(other.vialId, vialId) || other.vialId == vialId)&&(identical(other.patientAbhaId, patientAbhaId) || other.patientAbhaId == patientAbhaId)&&(identical(other.patientName, patientName) || other.patientName == patientName)&&(identical(other.orderId, orderId) || other.orderId == orderId)&&const DeepCollectionEquality().equals(other._testIds, _testIds)&&const DeepCollectionEquality().equals(other._status, _status)&&(identical(other.collectionTime, collectionTime) || other.collectionTime == collectionTime)&&(identical(other.integrityScore, integrityScore) || other.integrityScore == integrityScore)&&const DeepCollectionEquality().equals(other._chainOfCustody, _chainOfCustody)&&(identical(other.phlebotomistId, phlebotomistId) || other.phlebotomistId == phlebotomistId)&&(identical(other.phlebotomistName, phlebotomistName) || other.phlebotomistName == phlebotomistName)&&(identical(other.labId, labId) || other.labId == labId)&&(identical(other.labName, labName) || other.labName == labName)&&(identical(other.reachedLabTime, reachedLabTime) || other.reachedLabTime == reachedLabTime)&&(identical(other.processingStartTime, processingStartTime) || other.processingStartTime == processingStartTime)&&(identical(other.processingEndTime, processingEndTime) || other.processingEndTime == processingEndTime)&&(identical(other.coldChainData, coldChainData) || other.coldChainData == coldChainData)&&(identical(other.biometricVerification, biometricVerification) || other.biometricVerification == biometricVerification)&&(identical(other.preAnalyticalRisk, preAnalyticalRisk) || other.preAnalyticalRisk == preAnalyticalRisk)&&(identical(other.condition, condition) || other.condition == condition)&&(identical(other.notes, notes) || other.notes == notes)&&const DeepCollectionEquality().equals(other._imageUrls, _imageUrls)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,vialId,patientAbhaId,patientName,orderId,const DeepCollectionEquality().hash(_testIds),const DeepCollectionEquality().hash(_status),collectionTime,integrityScore,const DeepCollectionEquality().hash(_chainOfCustody),phlebotomistId,phlebotomistName,labId,labName,reachedLabTime,processingStartTime,processingEndTime,coldChainData,biometricVerification,preAnalyticalRisk,condition,notes,const DeepCollectionEquality().hash(_imageUrls),createdAt,updatedAt]);
...
@override $SampleIntegrityScoreModelCopyWith<$Res> get integrityScore;@override $ColdChainDataModelCopyWith<$Res>? get coldChainData;@override $BiometricVerificationModelCopyWith<$Res>? get biometricVerification;@override $PreAnalyticalRiskModelCopyWith<$Res>? get preAnalyticalRisk;@override $SampleConditionModelCopyWith<$Res>? get condition;
...
as Map<String, dynamic>,collectionTime: null == collectionTime ? _self.collectionTime : collectionTime // ignore: cast_nullable_to_non_nullable
as String,integrityScore: null == integrityScore ? _self.integrityScore : integrityScore // ignore: cast_nullable_to_non_nullable
as SampleIntegrityScoreModel,chainOfCustody: null == chainOfCustody ? _self._chainOfCustody : chainOfCustody // ignore: cast_nullable_to_non_nullable
as List<SampleEventModel>,phlebotomistId: freezed == phlebotomistId ? _self.phlebotomistId : phlebotomistId // ignore: cast_nullable_to_non_nullable
as String?,phlebotomistName: freezed == phlebotomistName ? _self.phlebotomistName : phlebotomistName // ignore: cast_nullable_to_non_nullable
as String?,labId: freezed == labId ? _self.labId : labId // ignore: cast_nullable_to_non_nullable
as String?,labName: freezed == labName ? _self.labName : labName // ignore: cast_nullable_to_non_nullable
...
mixin _$SampleConditionModel {
 ...
 bool get isHemolyzed; bool get isClotted; bool get isLipemic; bool get isIcteric; String get volumeStatus; String get containerIntegrity; String? get notes;
/// Create a copy of SampleConditionModel
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$SampleConditionModelCopyWith<SampleConditionModel> get copyWith => _$SampleConditionModelCopyWithImpl<SampleConditionModel>(this as SampleConditionModel, _$identity);
...
abstract mixin class $SampleConditionModelCopyWith<$Res>  {
  factory $SampleConditionModelCopyWith(SampleConditionModel value, $Res Function(SampleConditionModel) _then) = _$SampleConditionModelCopyWithImpl;
@useResult
$Res call({
 bool isHemolyzed, bool isClotted, bool isLipemic, bool isIcteric, String volumeStatus, String containerIntegrity, String? notes
});
...
as String,containerIntegrity: null == containerIntegrity ? _self.containerIntegrity : containerIntegrity // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _SampleConditionModel value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _SampleConditionModel value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _SampleConditionModel value)?  $default,){
final _that = this;
switch (_that) {
case _SampleConditionModel() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool isHemolyzed,  bool isClotted,  bool isLipemic,  bool isIcteric,  String volumeStatus,  String containerIntegrity,  String? notes)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SampleConditionModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool isHemolyzed,  bool isClotted,  bool isLipemic,  bool isIcteric,  String volumeStatus,  String containerIntegrity,  String? notes)  $default,) {final _that = this;
switch (_that) {
case _SampleConditionModel():
return $default(_that.isHemolyzed,_that.isClotted,_that.isLipemic,_that.isIcteric,_that.volumeStatus,_that.containerIntegrity,_that.notes);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool isHemolyzed,  bool isClotted,  bool isLipemic,  bool isIcteric,  String volumeStatus,  String containerIntegrity,  String? notes)?  $default,) {final _that = this;
switch (_that) {
case _SampleConditionModel() when $default != null:
return $default(_that.isHemolyzed,_that.isClotted,_that.isLipemic,_that.isIcteric,_that.volumeStatus,_that.containerIntegrity,_that.notes);case _:
  return null;
...
class _SampleConditionModel implements SampleConditionModel {
  const _SampleConditionModel({required this.isHemolyzed, required this.isClotted, required this.isLipemic, required this.isIcteric, required this.volumeStatus, required this.containerIntegrity, this.notes});
  factory _SampleConditionModel.fromJson(Map<String, dynamic> json) => _$SampleConditionModelFromJson(json);

@override final  bool isHemolyzed;
@override final  bool isClotted;
@override final  bool isLipemic;
@override final  bool isIcteric;
@override final  String volumeStatus;
@override final  String containerIntegrity;
@override final  String? notes;
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$SampleConditionModelCopyWith<_SampleConditionModel> get copyWith => __$SampleConditionModelCopyWithImpl<_SampleConditionModel>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$SampleConditionModelToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SampleConditionModel&&(identical(other.isHemolyzed, isHemolyzed) || other.isHemolyzed == isHemolyzed)&&(identical(other.isClotted, isClotted) || other.isClotted == isClotted)&&(identical(other.isLipemic, isLipemic) || other.isLipemic == isLipemic)&&(identical(other.isIcteric, isIcteric) || other.isIcteric == isIcteric)&&(identical(other.volumeStatus, volumeStatus) || other.volumeStatus == volumeStatus)&&(identical(other.containerIntegrity, containerIntegrity) || other.containerIntegrity == containerIntegrity)&&(identical(other.notes, notes) || other.notes == notes));
}
...
/// @nodoc
abstract mixin class _$SampleConditionModelCopyWith<$Res> implements $SampleConditionModelCopyWith<$Res> {
  factory _$SampleConditionModelCopyWith(_SampleConditionModel value, $Res Function(_SampleConditionModel) _then) = __$SampleConditionModelCopyWithImpl;
@override @useResult
$Res call({
 bool isHemolyzed, bool isClotted, bool isLipemic, bool isIcteric, String volumeStatus, String containerIntegrity, String? notes
});
...
mixin _$SampleEventModel {
 ...
 String get id; String get sampleId; String get eventType; String get actorId; String get actorName; String get actorRole; String get timestamp; GeoLocationModel get location; String get eventHash; String? get previousEventHash; EventMetadataModel? get metadata; String? get notes;
/// Create a copy of SampleEventModel
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$SampleEventModelCopyWith<SampleEventModel> get copyWith => _$SampleEventModelCopyWithImpl<SampleEventModel>(this as SampleEventModel, _$identity);
...
abstract mixin class $SampleEventModelCopyWith<$Res>  {
  factory $SampleEventModelCopyWith(SampleEventModel value, $Res Function(SampleEventModel) _then) = _$SampleEventModelCopyWithImpl;
@useResult
$Res call({
 String id, String sampleId, String eventType, String actorId, String actorName, String actorRole, String timestamp, GeoLocationModel location, String eventHash, String? previousEventHash, EventMetadataModel? metadata, String? notes
});


$GeoLocationModelCopyWith<$Res> get location;$EventMetadataModelCopyWith<$Res>? get metadata;
...
as GeoLocationModel,eventHash: null == eventHash ? _self.eventHash : eventHash // ignore: cast_nullable_to_non_nullable
...
as EventMetadataModel?,notes: freezed == notes ? _self.notes : notes // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
/// Create a copy of SampleEventModel
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _SampleEventModel value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _SampleEventModel value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _SampleEventModel value)?  $default,){
final _that = this;
switch (_that) {
case _SampleEventModel() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String sampleId,  String eventType,  String actorId,  String actorName,  String actorRole,  String timestamp,  GeoLocationModel location,  String eventHash,  String? previousEventHash,  EventMetadataModel? metadata,  String? notes)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SampleEventModel() when $default != null:
...
class _SampleEventModel implements SampleEventModel {
  const _SampleEventModel({required this.id, required this.sampleId, required this.eventType, required this.actorId, required this.actorName, required this.actorRole, required this.timestamp, required this.location, required this.eventHash, this.previousEventHash, this.metadata, this.notes});
  factory _SampleEventModel.fromJson(Map<String, dynamic> json) => _$SampleEventModelFromJson(json);
...
@override final  EventMetadataModel? metadata;
@override final  String? notes;
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$SampleEventModelCopyWith<_SampleEventModel> get copyWith => __$SampleEventModelCopyWithImpl<_SampleEventModel>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$SampleEventModelToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SampleEventModel&&(identical(other.id, id) || other.id == id)&&(identical(other.sampleId, sampleId) || other.sampleId == sampleId)&&(identical(other.eventType, eventType) || other.eventType == eventType)&&(identical(other.actorId, actorId) || other.actorId == actorId)&&(identical(other.actorName, actorName) || other.actorName == actorName)&&(identical(other.actorRole, actorRole) || other.actorRole == actorRole)&&(identical(other.timestamp, timestamp) || other.timestamp == timestamp)&&(identical(other.location, location) || other.location == location)&&(identical(other.eventHash, eventHash) || other.eventHash == eventHash)&&(identical(other.previousEventHash, previousEventHash) || other.previousEventHash == previousEventHash)&&(identical(other.metadata, metadata) || other.metadata == metadata)&&(identical(other.notes, notes) || other.notes == notes));
}
...
/// @nodoc
abstract mixin class _$SampleEventModelCopyWith<$Res> implements $SampleEventModelCopyWith<$Res> {
  factory _$SampleEventModelCopyWith(_SampleEventModel value, $Res Function(_SampleEventModel) _then) = __$SampleEventModelCopyWithImpl;
@override @useResult
$Res call({
 String id, String sampleId, String eventType, String actorId, String actorName, String actorRole, String timestamp, GeoLocationModel location, String eventHash, String? previousEventHash, EventMetadataModel? metadata, String? notes
});
...
@override $GeoLocationModelCopyWith<$Res> get location;@override $EventMetadataModelCopyWith<$Res>? get metadata;
...
mixin _$GeoLocationModel {
 ...
 double get latitude; double get longitude; double? get altitude; double? get accuracy; String? get timestamp;
...
@useResult
$Res call({
 double latitude, double longitude, double? altitude, double? accuracy, String? timestamp
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( double latitude,  double longitude,  double? altitude,  double? accuracy,  String? timestamp)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _GeoLocationModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( double latitude,  double longitude,  double? altitude,  double? accuracy,  String? timestamp)  $default,) {final _that = this;
switch (_that) {
case _GeoLocationModel():
return $default(_that.latitude,_that.longitude,_that.altitude,_that.accuracy,_that.timestamp);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( double latitude,  double longitude,  double? altitude,  double? accuracy,  String? timestamp)?  $default,) {final _that = this;
switch (_that) {
case _GeoLocationModel() when $default != null:
return $default(_that.latitude,_that.longitude,_that.altitude,_that.accuracy,_that.timestamp);case _:
  return null;
...
class _GeoLocationModel implements GeoLocationModel {
  const _GeoLocationModel({required this.latitude, required this.longitude, this.altitude, this.accuracy, this.timestamp});
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$EventMetadataModelCopyWith<EventMetadataModel> get copyWith => _$EventMetadataModelCopyWithImpl<EventMetadataModel>(this as EventMetadataModel, _$identity);
...
abstract mixin class $EventMetadataModelCopyWith<$Res>  {
  factory $EventMetadataModelCopyWith(EventMetadataModel value, $Res Function(EventMetadataModel) _then) = _$EventMetadataModelCopyWithImpl;
@useResult
$Res call({
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _EventMetadataModel value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _EventMetadataModel value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _EventMetadataModel value)?  $default,){
final _that = this;
switch (_that) {
case _EventMetadataModel() when $default != null:
return $default(_that);case _:
...
class _EventMetadataModel implements EventMetadataModel {
  const _EventMetadataModel({this.temperature, this.humidity, this.deviceId, this.appVersion, this.bleDeviceId, this.biometricSuccess, this.barcodeValue, final  Map<String, dynamic>? additionalData}): _additionalData = additionalData;
  factory _EventMetadataModel.fromJson(Map<String, dynamic> json) => _$EventMetadataModelFromJson(json);
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$EventMetadataModelCopyWith<_EventMetadataModel> get copyWith => __$EventMetadataModelCopyWithImpl<_EventMetadataModel>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$EventMetadataModelToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _EventMetadataModel&&(identical(other.temperature, temperature) || other.temperature == temperature)&&(identical(other.humidity, humidity) || other.humidity == humidity)&&(identical(other.deviceId, deviceId) || other.deviceId == deviceId)&&(identical(other.appVersion, appVersion) || other.appVersion == appVersion)&&(identical(other.bleDeviceId, bleDeviceId) || other.bleDeviceId == bleDeviceId)&&(identical(other.biometricSuccess, biometricSuccess) || other.biometricSuccess == biometricSuccess)&&(identical(other.barcodeValue, barcodeValue) || other.barcodeValue == barcodeValue)&&const DeepCollectionEquality().equals(other._additionalData, _additionalData));
}
...
/// @nodoc
abstract mixin class _$EventMetadataModelCopyWith<$Res> implements $EventMetadataModelCopyWith<$Res> {
  factory _$EventMetadataModelCopyWith(_EventMetadataModel value, $Res Function(_EventMetadataModel) _then) = __$EventMetadataModelCopyWithImpl;
@override @useResult
$Res call({
 double? temperature, double? humidity, String? deviceId, String? appVersion, String? bleDeviceId, bool? biometricSuccess, String? barcodeValue, Map<String, dynamic>? additionalData
});
...
mixin _$BiometricVerificationModel {
 ...
 String get verificationId; String get patientDeviceId; String get phlebotomistDeviceId; String get timestamp; bool get success; double get proximityDistance; int get signalStrength; String? get failureReason; int? get attemptCount; GeoLocationModel? get location;
/// Create a copy of BiometricVerificationModel
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$BiometricVerificationModelCopyWith<BiometricVerificationModel> get copyWith => _$BiometricVerificationModelCopyWithImpl<BiometricVerificationModel>(this as BiometricVerificationModel, _$identity);
...
abstract mixin class $BiometricVerificationModelCopyWith<$Res>  {
  factory $BiometricVerificationModelCopyWith(BiometricVerificationModel value, $Res Function(BiometricVerificationModel) _then) = _$BiometricVerificationModelCopyWithImpl;
@useResult
$Res call({
 String verificationId, String patientDeviceId, String phlebotomistDeviceId, String timestamp, bool success, double proximityDistance, int signalStrength, String? failureReason, int? attemptCount, GeoLocationModel? location
});
...
/// Create a copy of BiometricVerificationModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? verificationId = null,Object? patientDeviceId = null,Object? phlebotomistDeviceId = null,Object? timestamp = null,Object? success = null,Object? proximityDistance = null,Object? signalStrength = null,Object? failureReason = freezed,Object? attemptCount = freezed,Object? location = freezed,}) {
  return _then(_self.copyWith(
...
as bool,proximityDistance: null == proximityDistance ? _self.proximityDistance : proximityDistance // ignore: cast_nullable_to_non_nullable
...
as String?,attemptCount: freezed == attemptCount ? _self.attemptCount : attemptCount // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _BiometricVerificationModel value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _BiometricVerificationModel value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _BiometricVerificationModel value)?  $default,){
final _that = this;
switch (_that) {
case _BiometricVerificationModel() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String verificationId,  String patientDeviceId,  String phlebotomistDeviceId,  String timestamp,  bool success,  double proximityDistance,  int signalStrength,  String? failureReason,  int? attemptCount,  GeoLocationModel? location)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _BiometricVerificationModel() when $default != null:
return $default(_that.verificationId,_that.patientDeviceId,_that.phlebotomistDeviceId,_that.timestamp,_that.success,_that.proximityDistance,_that.signalStrength,_that.failureReason,_that.attemptCount,_that.location);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String verificationId,  String patientDeviceId,  String phlebotomistDeviceId,  String timestamp,  bool success,  double proximityDistance,  int signalStrength,  String? failureReason,  int? attemptCount,  GeoLocationModel? location)  $default,) {final _that = this;
switch (_that) {
case _BiometricVerificationModel():
return $default(_that.verificationId,_that.patientDeviceId,_that.phlebotomistDeviceId,_that.timestamp,_that.success,_that.proximityDistance,_that.signalStrength,_that.failureReason,_that.attemptCount,_that.location);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String verificationId,  String patientDeviceId,  String phlebotomistDeviceId,  String timestamp,  bool success,  double proximityDistance,  int signalStrength,  String? failureReason,  int? attemptCount,  GeoLocationModel? location)?  $default,) {final _that = this;
switch (_that) {
case _BiometricVerificationModel() when $default != null:
return $default(_that.verificationId,_that.patientDeviceId,_that.phlebotomistDeviceId,_that.timestamp,_that.success,_that.proximityDistance,_that.signalStrength,_that.failureReason,_that.attemptCount,_that.location);case _:
  return null;
...
class _BiometricVerificationModel implements BiometricVerificationModel {
  const _BiometricVerificationModel({required this.verificationId, required this.patientDeviceId, required this.phlebotomistDeviceId, required this.timestamp, required this.success, required this.proximityDistance, required this.signalStrength, this.failureReason, this.attemptCount, this.location});
  factory _BiometricVerificationModel.fromJson(Map<String, dynamic> json) => _$BiometricVerificationModelFromJson(json);
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$BiometricVerificationModelCopyWith<_BiometricVerificationModel> get copyWith => __$BiometricVerificationModelCopyWithImpl<_BiometricVerificationModel>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$BiometricVerificationModelToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _BiometricVerificationModel&&(identical(other.verificationId, verificationId) || other.verificationId == verificationId)&&(identical(other.patientDeviceId, patientDeviceId) || other.patientDeviceId == patientDeviceId)&&(identical(other.phlebotomistDeviceId, phlebotomistDeviceId) || other.phlebotomistDeviceId == phlebotomistDeviceId)&&(identical(other.timestamp, timestamp) || other.timestamp == timestamp)&&(identical(other.success, success) || other.success == success)&&(identical(other.proximityDistance, proximityDistance) || other.proximityDistance == proximityDistance)&&(identical(other.signalStrength, signalStrength) || other.signalStrength == signalStrength)&&(identical(other.failureReason, failureReason) || other.failureReason == failureReason)&&(identical(other.attemptCount, attemptCount) || other.attemptCount == attemptCount)&&(identical(other.location, location) || other.location == location));
}
...
/// @nodoc
abstract mixin class _$BiometricVerificationModelCopyWith<$Res> implements $BiometricVerificationModelCopyWith<$Res> {
  factory _$BiometricVerificationModelCopyWith(_BiometricVerificationModel value, $Res Function(_BiometricVerificationModel) _then) = __$BiometricVerificationModelCopyWithImpl;
@override @useResult
$Res call({
 String verificationId, String patientDeviceId, String phlebotomistDeviceId, String timestamp, bool success, double proximityDistance, int signalStrength, String? failureReason, int? attemptCount, GeoLocationModel? location
});
...
/// Create a copy of BiometricVerificationModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? verificationId = null,Object? patientDeviceId = null,Object? phlebotomistDeviceId = null,Object? timestamp = null,Object? success = null,Object? proximityDistance = null,Object? signalStrength = null,Object? failureReason = freezed,Object? attemptCount = freezed,Object? location = freezed,}) {
