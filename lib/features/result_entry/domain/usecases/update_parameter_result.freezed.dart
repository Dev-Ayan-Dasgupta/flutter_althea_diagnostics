...
mixin _$UpdateParameterResultParams {
  ...
  $UpdateParameterResultParamsCopyWith<UpdateParameterResultParams>
      get copyWith => _$UpdateParameterResultParamsCopyWithImpl<
              UpdateParameterResultParams>(
          this as UpdateParameterResultParams, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UpdateParameterResultParams &&
...
abstract mixin class $UpdateParameterResultParamsCopyWith<$Res> {
  factory $UpdateParameterResultParamsCopyWith(
          ...
          $Res Function(UpdateParameterResultParams) _then) =
      _$UpdateParameterResultParamsCopyWithImpl;
  @useResult
  $Res call(
      {String resultId,
      String testId,
...
extension UpdateParameterResultParamsPatterns on UpdateParameterResultParams {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_UpdateParameterResultParams value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String resultId, String testId, String parameterId,
            ResultValue value, String? notes)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _UpdateParameterResultParams() when $default != null:
        return $default(_that.resultId, _that.testId, _that.parameterId,
            _that.value, _that.notes);
      case _:
        return orElse();
    }
  }
...
class _UpdateParameterResultParams implements UpdateParameterResultParams {
  const _UpdateParameterResultParams(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$UpdateParameterResultParamsCopyWith<_UpdateParameterResultParams>
      get copyWith => __$UpdateParameterResultParamsCopyWithImpl<
          _UpdateParameterResultParams>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _UpdateParameterResultParams &&
            (identical(other.resultId, resultId) ||
                other.resultId == resultId) &&
            (identical(other.testId, testId) || other.testId == testId) &&
            (identical(other.parameterId, parameterId) ||
...
/// @nodoc
abstract mixin class _$UpdateParameterResultParamsCopyWith<$Res>
    implements $UpdateParameterResultParamsCopyWith<$Res> {
  factory _$UpdateParameterResultParamsCopyWith(
          _UpdateParameterResultParams value,
          $Res Function(_UpdateParameterResultParams) _then) =
      __$UpdateParameterResultParamsCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String resultId,
